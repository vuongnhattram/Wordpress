...
jQuery("#form-option").submit(function(e)
{
	...
	jQuery.ajax(
	{
		...
		jQuery( ".gardenia-themes .btn-save input" ).addClass( "save-details" );
		jQuery(".gardenia-themes .btn-save input").val('Options saved successfully');
		setTimeout(function () {
            jQuery( ".gardenia-themes .btn-save input" ).removeClass( "save-details" );
            jQuery(".gardenia-themes .btn-save input").val('Save options');
